/*
  ...
  * @brief   Header do arquivo que configura a parte complexa do codigo do foguete.
...
#ifdef EM_VOO // Definitivos

	#define ALTITUDE_LANCAMENTO  10.0f
	#define VELOCIDADE_LANCAMENTO 6.0f // playing it safe aqui
	#define ALTITUDE_POUSO       30.0f
	#define VELOCIDADE_POUSO     30.0f
	#define DESCIDA_MINIMA       20.0f
	#define META_APOGEU          500.0f // Defina a meta em metros aqui
	#define DESVIO_MIN           15.0f
	#define ALTITUDE_MIN_EJECAO  20.0f
	#define TEMPO_MAX_VOO_MS     1500000UL  // (25 minutos) Tempo maximo de voo para parar de gravar
...
// AJUSTAR DEPOIS
	...
	#define ALTITUDE_POUSO       1.0f
	#define VELOCIDADE_POUSO     1.0f
	#define DESCIDA_MINIMA       5.0f
	#define META_APOGEU          9.0f  // Meta menor para testes
	#define DESVIO_MIN           1.0f
	#define ALTITUDE_MIN_EJECAO  3.0f
	#define TEMPO_MAX_VOO_MS     600000UL // (10 minutos)
...
// Variaveis ou constantes que serão definidas em config_voo.c
...
void simularVooAoVivoUSB(void);
	...
	// Se o seu buzzer liga com LOW (Logica Invertida / Active-Low)
